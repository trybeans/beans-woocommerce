...
<div id="beans-section" class="beans-section beans-reward-reset">
  ...
  <div id="beans-block-intro" style="display: none;">
    <div class="beans-intro beans-clearfix">
      ...
      <div class="beans-intro-content">
        Join our customer rewards program and get <span id="beans-if-join"></span>
  ...
  <div id="beans-block-help">
    ...
    <h3 class="beans-help-title" id="beans-help-redemption">How do I spend my <span class="beans-beans_name"></span>?
    </h3>
    <p>
...
{#      </span>#}
      ...
      <ol>
        ...
        <li>
          ...
          <span beans-help="beans:refer_friend_two_sided">
                      Your friend will received an additional <span
                beans-rule_beans="beans:refer_friend_two_sided"></span>
        ...
        <li beans-help="beans:refer_friend_fixed">
          ...
          <span class="beans-currency_symbol"></span><span
              beans-rule_settings="beans:refer_friend_fixed:minimum"></span>
          you will get <span beans-rule_beans="beans:refer_friend_fixed"></span>.
        </li>
        <li beans-help="beans:refer_friend_percent"> You will get
          a <span id="beans_refer_friend_percent_commission"></span>% commission (in <span
              class="beans-beans_name"></span>)
          for <span beans-rule_settings="beans:refer_friend_percent:all_purchases_str"></span> purchase they make.
        </li>
      </ol>
    </div>

    <div class="beans-help-block" beans-help="beans:fb_page_like">
      <h3 class="beans-help-title" id="beans-help-fb">How do I get <span class="beans-beans_name"></span> for liking on
        Facebook?</h3>
      <ol>
        <li>Make sure your Facebook account is connected <a href="@card_url/settings/general/" target="_blank">here</a>.
        </li>
    ...
    <div class="beans-help-block" beans-help="beans:twitter_follow">
      <h3 class="beans-help-title" id="beans-help-twitter">How do I get <span class="beans-beans_name"></span> for
        following on Twitter?</h3>
      <ol>
        <li>Make sure your Twitter account is connected <a href="@card_url/settings/general/" target="_blank">here</a>.
        </li>
    ...
    <div class="beans-help-block" beans-help="beans:birthday">
      <h3 class="beans-help-title" id="beans-help-birthday">How do I get <span class="beans-beans_name"></span> for my
        birthday?</h3>
      <ol>
