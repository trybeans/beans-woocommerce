...
class LianaBlocks
{
    ...
    public static function init($display)
    {
        ...
        if (get_option(Helper::OPTIONS['subscription_redemption']['handle'])) {
            add_action(
